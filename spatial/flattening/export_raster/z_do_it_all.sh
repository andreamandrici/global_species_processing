...
#./a_input_general.sh ${ncores} > logs/a_input_general_log.txt 2>&1 wait

# B-CLIP TABLES
## populates clip tables
#./b_clip_general.sh ${ncores} > logs/b_clip_general_log.txt 2>&1 wait

# C-RASTER TABLES
## populates raster tables
#./c_rast_general.sh ${ncores} > logs/c_raster_general_log.txt 2>&1 wait

# D-TILED TABLES
## DA-populates tiled tables (in parallel)
#./da_tiled_general.sh ${ncores} > logs/da_tiled_general_log.txt 2>&1 wait
