...
SELECT qid,cid,geom
FROM species_2022_all_taxa.mammals_flat ---<---- DEFINE IT HERE!
--WHERE mammals && '{59468,136135}'
; ---<---- FILTER IT HERE!
----------------------------------------------------------
DROP TABLE IF EXISTS flat_attributes;CREATE TEMPORARY TABLE flat_attributes AS
SELECT cid,
mammals_richness ncid ---<---- DEFINE IT HERE!
FROM species_2022_all_taxa.mammals_attributes ---<---- DEFINE IT HERE!
;
--- threatened
-- DROP TABLE IF EXISTS flat_attributes;CREATE TEMPORARY TABLE flat_attributes AS
-- SELECT cid,
-- mammals_threatened_richness ncid ---<---- DEFINE IT HERE!
-- FROM species_2022_all_taxa.mammals_attributes ---<---- DEFINE IT HERE!
-- WHERE mammals_threatened_richness IS NOT NULL ---<---- DEFINE IT HERE!
-- ; 
-- --- endemic
-- DROP TABLE IF EXISTS flat_attributes;CREATE TEMPORARY TABLE flat_attributes AS
-- SELECT cid,
-- mammals_endemic_richness ncid ---<---- DEFINE IT HERE!
-- FROM species_2022_all_taxa.mammals_attributes ---<---- DEFINE IT HERE!
-- WHERE mammals_endemic_richness IS NOT NULL ---<---- DEFINE IT HERE!
-- ;
-- --- threatened_endemic
-- DROP TABLE IF EXISTS flat_attributes;CREATE TEMPORARY TABLE flat_attributes AS
-- SELECT cid,
-- mammals_threatened_endemic_richness ncid ---<---- DEFINE IT HERE!
-- FROM species_2022_all_taxa.mammals_attributes ---<---- DEFINE IT HERE!
-- WHERE mammals_threatened_endemic_richness IS NOT NULL ---<---- DEFINE IT HERE!
-- ;
----------------------------------------------------------
