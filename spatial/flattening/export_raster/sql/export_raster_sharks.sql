...
SELECT qid,cid,geom
FROM species_2022_all_taxa.sharks_flat ---<---- DEFINE IT HERE!
-- WHERE sharks && '{59468,136135}' ---<---- FILTER IT HERE!
; 
----------------------------------------------------------
-- DROP TABLE IF EXISTS flat_attributes;CREATE TEMPORARY TABLE flat_attributes AS
-- SELECT cid,
-- sharks_richness ncid ---<---- DEFINE IT HERE!
-- FROM species_2022_all_taxa.sharks_attributes ---<---- DEFINE IT HERE!
-- ;
-- threatened
-- DROP TABLE IF EXISTS flat_attributes;CREATE TEMPORARY TABLE flat_attributes AS
-- SELECT cid,
-- sharks_threatened_richness ncid ---<---- DEFINE IT HERE!
-- FROM species_2022_all_taxa.sharks_attributes ---<---- DEFINE IT HERE!
-- WHERE sharks_threatened_richness IS NOT NULL ---<---- DEFINE IT HERE!
-- ; 
--- endemic
-- DROP TABLE IF EXISTS flat_attributes;CREATE TEMPORARY TABLE flat_attributes AS
-- SELECT cid,
-- sharks_endemic_richness ncid ---<---- DEFINE IT HERE!
-- FROM species_2022_all_taxa.sharks_attributes ---<---- DEFINE IT HERE!
-- WHERE sharks_endemic_richness IS NOT NULL ---<---- DEFINE IT HERE!
-- ;
--- threatened_endemic
DROP TABLE IF EXISTS flat_attributes;CREATE TEMPORARY TABLE flat_attributes AS
SELECT cid,
sharks_threatened_endemic_richness ncid ---<---- DEFINE IT HERE!
FROM species_2022_all_taxa.sharks_attributes ---<---- DEFINE IT HERE!
WHERE sharks_threatened_endemic_richness IS NOT NULL ---<---- DEFINE IT HERE!
;

SELECT * FROM species_2022_all_taxa.sharks_attributes WHERE sharks_threatened_richness IS NOT NULL AND sharks_endemic_richness  IS NOT NULL
----------------------------------------------------------
