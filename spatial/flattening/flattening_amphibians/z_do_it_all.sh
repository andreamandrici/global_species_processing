...
#./a_input_amphibians.sh ${ncores} > logs/a_input_amphibians_log.txt 2>&1 wait

# B-CLIP TABLES
## populates clip tables
#./b_clip_amphibians.sh ${ncores} > logs/b_clip_amphibians_log.txt 2>&1 wait

# C-RASTER TABLES
## populates raster tables
#./c_rast_amphibians.sh ${ncores} > logs/c_raster_amphibians_log.txt 2>&1 wait

# D-TILED TABLES
## DA-populates tiled tables (in parallel)
#./da_tiled_amphibians.sh ${ncores} > logs/da_tiled_amphibians_log.txt 2>&1 wait
