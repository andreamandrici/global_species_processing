...
#./a_input_sharks.sh ${ncores} > logs/a_input_sharks_log.txt 2>&1 wait

# B-CLIP TABLES
## populates clip tables
#./b_clip_sharks.sh ${ncores} > logs/b_clip_sharks_log.txt 2>&1 wait

# C-RASTER TABLES
## populates raster tables
./c_rast_sharks.sh ${ncores} > logs/c_raster_sharks_log.txt 2>&1 wait

# D-TILED TABLES
## DA-populates tiled tables (in parallel)
./da_tiled_sharks.sh ${ncores} > logs/da_tiled_sharks_log.txt 2>&1 wait
