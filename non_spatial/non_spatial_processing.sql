...
DROP TABLE IF EXISTS dopa.class_species_habitat CASCADE;
CREATE TABLE dopa.class_species_habitat AS
...
DROP TABLE IF EXISTS dopa.class_species_stress CASCADE;
CREATE TABLE dopa.class_species_stress AS
SELECT * FROM mt_stresses ORDER BY code;

DROP TABLE IF EXISTS dopa.class_species_threat CASCADE;
CREATE TABLE dopa.class_species_threat AS
...
DROP TABLE IF EXISTS dopa.class_species_country CASCADE;
CREATE TABLE dopa.class_species_country AS
